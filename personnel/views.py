...
class PersonnelListCreateView(generics.ListCreateAPIView):
    ...
    # bu create metodunu ListCreateApiView den override ederek yalnızca staff'ın create edebilmesini sağladık. O nedenle permission_classes'dan IsstaffOrReadOnly ' yi çıkarttık
    ...
    def create(self, request, *args, **kwargs):
        ...
        if self.request.user.is_staff:
            ...
            data ={
                "message":f"Personal {personnel.first_name} saved succesfully.",
                "personnel" :serializer.data
            }
        else:
            data ={
                "message":"You are not authorized to perform this operation. Yetkin yok. Uzatma..."
            }
...
class PersonalGetUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Personnel.objects.all()
    serializer_class = PersonnelSerializer
